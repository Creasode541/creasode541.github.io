...
function loadWeather() {
  var weather = $("#weather");
  var url = "https://api.darksky.net/forecast/"; //Dark Sky API url
  var apiKey = "f306d19cf917160605c96db6cc0a2768"; // API key from Dark Sky
...
function loadNews() {
  ...
  var apiKey = "d69b7f7ccafe4f3fbb06661627c978dd"; // API key from News API
